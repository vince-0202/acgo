...
//	"github.com/vince-0202/acgo/pkg/ctx"
...
//
//func (c *Client) Complete(callCtx ctx.Context, model llm.Model, opts *llm.Options) (ctx.Message, llm.Usage, error) {
//	if strings.TrimSpace(c.apiKey) == "" {
//		return ctx.Message{}, llm.Usage{}, fmt.Errorf("provider api key is not set")
//	}
//	reqBody := buildRequest(callCtx, opts)
//	respBody, err := c.callGenerate(callCtx, model.ID, reqBody, false)
//	if err != nil {
//		return ctx.Message{}, llm.Usage{}, err
//	}
